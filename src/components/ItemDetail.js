...
class ItemDetail extends Component {
    render() {
        return (
            ...
            <Col md={3}><Link to={"/product?id="+this.props.id} className="shop-holder"><img src={API_URL_1+'/'+this.props.image+'.jpg'} style={{width:"100%"}}/><div className="shop-overlay">{this.props.name}</div></Link></Col>
