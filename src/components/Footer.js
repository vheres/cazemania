        ...
        return(
            <Grid fluid className="Footer-css text-left">
                <Row className="margin-bot-15">
                        <Col xsOffset={2} xs={10} mdOffset={2} md={3}>
                            <Row>
                        ...
                        <Col xsOffset={2} xs={10} mdOffset={0} md={3}>
                            ...
                            <Row>
                                <a href="https://www.facebook.com/Cazemania-145109639470441/" target="_blank"><img src="http://www.dfmalherbe.co.za/wp-content/uploads/2016/01/facebook-logo-png-transparent-background.png" alt="facebook" style={{width:"45px"}}></img></a><span className="text-white facebook-text">Cazemania</span>
                            </Row>
                        </Col>
                        <Col xsOffset={2} xs={10} mdOffset={0} md={4}>
                            <Row>
                            ...
                            <Row>
                                <a href="https://www.facebook.com/Cazemania-145109639470441/" target="_blank"><img src="https://images.sftcdn.net/images/t_optimized,f_auto/p/cc03a0ea-96d0-11e6-9905-00163ed833e7/1398466786/whatsapp-logo.png" alt="whatsapp" style={{width:"50px"}}></img></a>
                            </Row>
                        </Col>
                </Row>
            </Grid>
